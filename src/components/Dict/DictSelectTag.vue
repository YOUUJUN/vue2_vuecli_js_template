<template>
	<a-radio-group v-if="tagType == 'radio'" @change="handleInput" :value="getValueSting" :disabled="disabled">
		<a-radio v-for="(item, key) in dictOptions" :key="key" :value="item.itemValue">{{ item.itemText }}</a-radio>
	</a-radio-group>
	...
	<a-radio-group
		...
		:disabled="disabled"
	>
		<a-radio-button v-for="(item, key) in dictOptions" :key="key" :value="item.itemValue">
			{{ item.itemText }}
		</a-radio-button>
	</a-radio-group>
	...
	<a-select
		...
		@select="handleSelect"
	>
		<a-select-option v-if="blank" :value="null">请选择</a-select-option>
