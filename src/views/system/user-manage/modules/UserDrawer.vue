...
export default {
	...
	computed: {
		detailFormRules() {
			return {
				...
				password: { required: this.passwordRequired, message: '请输入用户密码', trigger: 'blur' },
	...
	methods: {
		...
		handleStatusChange(checked) {
			this.detailForm.status = Number(checked)
		},
	},
}
</script>
