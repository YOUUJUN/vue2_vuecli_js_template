			...
			queryPermissionsByUser({
				...
				.then((response) => {
					...
					if (success) {
						...
						ls.set(USER_AUTH, JSON.stringify(authData), tokenExpirationTime)
						ls.set(SYS_BUTTON_AUTH, JSON.stringify(allAuthData), tokenExpirationTime)
